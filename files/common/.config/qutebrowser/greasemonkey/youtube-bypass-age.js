...
(function iife(ranOnce) {
  ...
  function isWatchNextSidebarEmpty(parsedData) {
    ...
    if (isDesktop) {
      ...
      const result =
        ...
        _parsedData$contents === void 0 ||
        (_parsedData$contents = _parsedData$contents.secondaryResults) ===
          null ||
        _parsedData$contents === void 0 ||
        (_parsedData$contents = _parsedData$contents.secondaryResults) ===
          null ||
  ...
  function isAgeRestricted(playabilityStatus) {
    ...
    return (
      ...
      _playabilityStatus$er === void 0 ||
      (_playabilityStatus$er = _playabilityStatus$er.reason) === null ||
      _playabilityStatus$er === void 0 ||
      (_playabilityStatus$er = _playabilityStatus$er.runs) === null ||
      _playabilityStatus$er === void 0 ||
      (_playabilityStatus$er = _playabilityStatus$er.find(
        (x) => x.navigationEndpoint,
      )) === null ||
      _playabilityStatus$er === void 0 ||
      (_playabilityStatus$er = _playabilityStatus$er.navigationEndpoint) ===
        null ||
      _playabilityStatus$er === void 0 ||
      (_playabilityStatus$er = _playabilityStatus$er.urlEndpoint) === null ||
      _playabilityStatus$er === void 0 ||
  ...
  function isSearchResult(parsedData) {
    ...
    return (
      ...
      parsedData === void 0 ||
      (_parsedData$contents3 = parsedData.contents) === null ||
      _parsedData$contents3 === void 0
        ? void 0
        : _parsedData$contents3.twoColumnSearchResultsRenderer) === "object" || // Desktop initial results
      (parsedData === null ||
      parsedData === void 0 ||
      (_parsedData$contents4 = parsedData.contents) === null ||
      _parsedData$contents4 === void 0 ||
      (_parsedData$contents4 = _parsedData$contents4.sectionListRenderer) ===
        null ||
      _parsedData$contents4 === void 0
        ? void 0
      ...
      (_parsedData$onRespons = _parsedData$onRespons.find(
  ...
  function sendInnertubeRequest(endpoint, payload, useAuth) {
    ...
    xmlhttp.open(
      "POST",
      `/youtubei/${endpoint}?key=${getYtcfgValue("INNERTUBE_API_KEY")}&prettyPrint=false`,
      false,
    );
  ...
  function getUnlockStrategies$1(videoId, lastPlayerUnlockReason) {
    ...
    const userInterfaceTheme =
      (_getYtcfgValue$client =
        getYtcfgValue("INNERTUBE_CONTEXT").client.userInterfaceTheme) !==
        null && _getYtcfgValue$client !== void 0
        ? _getYtcfgValue$client
  ...
  function getUnlockedPlayerResponse(videoId, reason) {
    ...
    unlockStrategies.every((strategy, index) => {
      ...
      if (isStatusValid) {
        ...
        if (
          ...
          !(
            (_unlockedPlayerRespon7 =
              unlockedPlayerResponse.responseContext) !== null &&
         ...
         */
        if (
          strategy.payload.startTimeSecs &&
          strategy.name === "Account Proxy"
        ) {
  ...
  function mergeNextResponse(originalNextResponse, unlockedNextResponse) {
    ...
    const unlockedWatchNextFeed =
      ...
      (_unlockedNextResponse = _unlockedNextResponse.results) === null ||
      _unlockedNextResponse === void 0 ||
      (_unlockedNextResponse = _unlockedNextResponse.contents) === null ||
      _unlockedNextResponse === void 0
        ? void 0
        : _unlockedNextResponse.find((x) => {
  ...
  function handleFetchRequest(url, requestOptions) {
    ...
    if (
      url_obj.pathname.indexOf("/youtubei/") === 0 &&
